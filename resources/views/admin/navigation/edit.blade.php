...
<div class="container-fluid py-4">
    <div class="row mb-4">
        <div class="col-md-8">
            <h2 class="mb-0">Edit Navigation Item</h2>
            <p class="text-muted">Update navigation link details</p>
        </div>
    ...
    <div class="row">
                    ...
                    <form action="{{ route('admin.navigation.update', $navigation) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('url') is-invalid @enderror" 
                                   ...
                                   value="{{ old('url', $navigation->url) }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('content') is-invalid @enderror" 
                                      ...
                                      placeholder="Optional: Add a description or tooltip">{{ old('content', $navigation->content) }}</textarea>
        ...
        <div class="col-md-4">
            ...
            <div class="card mt-3">
                ...
                <div class="card-body">
                    <form action="{{ route('admin.navigation.destroy', $navigation) }}" method="POST">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="btn btn-danger btn-sm w-100" onclick="return confirm('Are you sure? This action cannot be undone.')">
                            <i class="fas fa-trash"></i> Delete Navigation Item
                        </button>
                    </form>
                </div>
            </div>
