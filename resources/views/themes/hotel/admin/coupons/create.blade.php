...
<div class="container-fluid p-0">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            ...
            <p class="text-muted small">Create a new promotion or discount for your hotel.</p>
        </div>
            ...
            <div class="col-lg-8">
                <div class="admin-card mb-4">
                    <div class="mb-3">
                        ...
                        <input type="text" name="title" class="form-control form-control-sm @error('title') is-invalid @enderror" value="{{ old('title') }}" placeholder="e.g. Summer Special 20% Off" required>
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="code" class="form-control form-control-sm @error('code') is-invalid @enderror" value="{{ old('code') }}" placeholder="SUMMER20">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="description" class="form-control form-control-sm @error('description') is-invalid @enderror" rows="4" placeholder="Describe the offer...">{{ old('description') }}</textarea>
            ...
            <div class="col-lg-4">
                <div class="admin-card mb-4">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" name="expire_date" class="form-control form-control-sm @error('expire_date') is-invalid @enderror" value="{{ old('expire_date') }}">
                ...
                <div class="admin-card">
                    ...
                    <div class="mb-3">
                        ...
                        <p class="text-muted extra-small mt-2">Recommended size: 800x600 for offers.</p>
                    </div>
                </div>

                <div class="mt-4">
                    <button type="submit" class="btn btn-primary w-100 py-2 fw-bold">Save {{ ucfirst($type) }}</button>
                </div>
            </div>
        </div>
    </form>
